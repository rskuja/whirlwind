...
class BaseRequest(RequestHandler):
    ...
    def get_user_locale(self): 
        ...
        elif self.get_cookie("locale"):
            return locale.get(self.get_cookie("locale"))
        else:
            return locale.get()

    def get_current_locale_name(self):
        if self.current_user and "locale" in self.current_user: 
    ...
    # called by a handler which is invoked by user action 
    # to override what FB returned 
    def set_user_locale(self,locale="en_US"):
    ...
    def render_template(self,template_name, **kwargs):
        ...
        tornado_args = {
            ...
            "locale": self.get_current_locale_name(),
